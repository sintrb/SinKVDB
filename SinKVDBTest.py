...
class SinKVDBTest(unittest.TestCase):
	...
	def __init__(self, methodName):
		...
		self.predict['unicode'] = u'this is string'
		self.predict['int'] = 1
	...
	def test2Comp(self):
		...
		self.assertEquals(self.kvdb['unicode'], self.predict['unicode'], 'str not eq')
	...
	def test6Del(self):
		...
		self.assertEquals(self.kvdb['unicode'], None, 'unicode not deleted')
